...
import io.cuetime.cuetimekeyboard.inputmethod.latin.AudioAndHapticFeedbackManager
import io.cuetime.cuetimekeyboard.inputmethod.latin.InputAttributes
    ...
    companion object {
        ...
        fun readPrefSubtypes(prefs: SharedPreferences): String {
            return prefs.getString(
                io.cuetime.cuetimekeyboard.inputmethod.latin.settings.Settings.Companion.PREF_ENABLED_SUBTYPES,
                ""
            )!!
        }
